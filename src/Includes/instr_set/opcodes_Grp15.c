    ...
    if (GV.REGOPCODE == 0) {
        ...
        if (GV.MOD_!= 0x3) {
            ...
            (*pMyDisasm).Instruction.Category = FPU_INSTRUCTION+STATE_MANAGEMENT;
               ...
               (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"fxsave ");
            #endif
        ...
        if (GV.MOD_!= 0x3) {
            ...
            (*pMyDisasm).Instruction.Category = FPU_INSTRUCTION+STATE_MANAGEMENT;
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"fxrstor ");
            #endif
            (*pMyDisasm).Argument2.ArgSize = 512;
        ...
        if (GV.MOD_!= 0x3) {
            ...
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"ldmxcsr ");
            #endif
        ...
        if (GV.MOD_!= 0x3) {
            ...
            (*pMyDisasm).Instruction.Category = SSE_INSTRUCTION+STATE_MANAGEMENT;
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"stmxcsr ");
            #endif
        ...
        if (GV.MOD_!= 0x3) {
            ...
            (*pMyDisasm).Instruction.Category = FPU_INSTRUCTION+STATE_MANAGEMENT;
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"xsave ");
            #endif
            (*pMyDisasm).Argument1.ArgSize = 512;
            (*pMyDisasm).Argument2.ArgType = REGISTER_TYPE+FPU_REG+MMX_REG+SSE_REG;
            (*pMyDisasm).Argument2.ArgSize = 512;
        ...
        if (GV.MOD_== 0x3) {
            ...
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"lfence ");
            #endif
        }
        else {
            MOD_RM(&(*pMyDisasm).Argument2, pMyDisasm);
            ...
            (*pMyDisasm).Instruction.Category = FPU_INSTRUCTION+STATE_MANAGEMENT;
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"xrstor ");
            #endif
            (*pMyDisasm).Argument2.ArgSize = 512;
            (*pMyDisasm).Argument1.ArgType = REGISTER_TYPE+FPU_REG+MMX_REG+SSE_REG;
            (*pMyDisasm).Argument1.ArgSize = 512;
        ...
        if (GV.MOD_== 0x3) {
            (*pMyDisasm).Instruction.Category = SSE2_INSTRUCTION+CACHEABILITY_CONTROL;
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"mfence ");
            #endif
        }
        else {
            FailDecode(pMyDisasm);
        ...
        if (GV.MOD_== 0x3) {
            (*pMyDisasm).Instruction.Category = SSE2_INSTRUCTION+CACHEABILITY_CONTROL;
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"sfence ");
            #endif
        }
        else {
            GV.OperandSize = 8;
            ...
            (*pMyDisasm).Instruction.Category = SSE2_INSTRUCTION+CACHEABILITY_CONTROL;
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"clflush ");
            #endif
        }
