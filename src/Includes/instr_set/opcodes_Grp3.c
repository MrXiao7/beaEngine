...
void __bea_callspec__ G3_Eb(PDISASM pMyDisasm)
{
    ...
    if (GV.REGOPCODE == 0) {
        ...
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"not ");
        #endif
        Eb(pMyDisasm);
        ...
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"neg ");
        #endif
        Eb(pMyDisasm);
        ...
        (*pMyDisasm).Instruction.Category = GENERAL_PURPOSE_INSTRUCTION+ARITHMETIC_INSTRUCTION;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"mul ");
        #endif
        ...
        (*pMyDisasm).Instruction.Category = GENERAL_PURPOSE_INSTRUCTION+ARITHMETIC_INSTRUCTION;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"div ");
        #endif
        GV.MemDecoration = Arg2byte;
        GV.OperandSize = 8;
        MOD_RM(&(*pMyDisasm).Argument2, pMyDisasm);
        ...
        (*pMyDisasm).Instruction.Category = GENERAL_PURPOSE_INSTRUCTION+ARITHMETIC_INSTRUCTION;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"idiv ");
        #endif
        GV.MemDecoration = Arg2byte;
        GV.OperandSize = 8;
        MOD_RM(&(*pMyDisasm).Argument2, pMyDisasm);
