...
void __bea_callspec__ G2_EbIb(PDISASM pMyDisasm)
{
    ...
    if (GV.REGOPCODE == 0) {
        (*pMyDisasm).Instruction.Category = GENERAL_PURPOSE_INSTRUCTION+SHIFT_ROTATE;
           ...
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"rol ");
        #endif
        ...
        (*pMyDisasm).Instruction.Category = GENERAL_PURPOSE_INSTRUCTION+SHIFT_ROTATE;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"ror ");
        #endif
        FillFlags(pMyDisasm, 88);
    }
        ...
        (*pMyDisasm).Instruction.Category = GENERAL_PURPOSE_INSTRUCTION+SHIFT_ROTATE;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"rcl ");
        #endif
        ...
        (*pMyDisasm).Instruction.Category = GENERAL_PURPOSE_INSTRUCTION+SHIFT_ROTATE;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"rcr ");
        #endif
        FillFlags(pMyDisasm, 81);
    }
        ...
        (*pMyDisasm).Instruction.Category = GENERAL_PURPOSE_INSTRUCTION+SHIFT_ROTATE;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"shl ");
        #endif
        ...
        (*pMyDisasm).Instruction.Category = GENERAL_PURPOSE_INSTRUCTION+SHIFT_ROTATE;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"shr ");
        #endif
        FillFlags(pMyDisasm, 92);
    }
        ...
        (*pMyDisasm).Instruction.Category = GENERAL_PURPOSE_INSTRUCTION+SHIFT_ROTATE;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"sal ");
        #endif
        FillFlags(pMyDisasm, 92);
    }
        ...
        (*pMyDisasm).Instruction.Category = GENERAL_PURPOSE_INSTRUCTION+SHIFT_ROTATE;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"sar ");
        #endif
        FillFlags(pMyDisasm, 92);
    }
}
...
void __bea_callspec__ G2_Eb1(PDISASM pMyDisasm)
{
    ...
    GV.OperandSize = 32;
    #ifndef BEA_LIGHT_DISASSEMBLY
       (void) strcpy_s ((*pMyDisasm).Argument2.ArgMnemonic,64, "1 ");
    #endif
...
void __bea_callspec__ G2_EbCL(PDISASM pMyDisasm)
{
    ...
    GV.OperandSize = 32;
    #ifndef BEA_LIGHT_DISASSEMBLY
       (void) strcpy_s ((*pMyDisasm).Argument2.ArgMnemonic,64, Registers8Bits[1]);
    #endif
