...
void __bea_callspec__ emms_(PDISASM pMyDisasm)
{
	(*pMyDisasm).Instruction.Category = MMX_INSTRUCTION+STATE_MANAGEMENT;
       ...
       (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"emms ");
    #endif
	GV.EIP_++;
}
...
void __bea_callspec__ movd_EP(PDISASM pMyDisasm)
{
    ...
    if (GV.PrefRepe == 1) {
        ...
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"movq ");
        #endif
        GV.SSE_ = 1;
    ...
    /* ========== 0x66 */
        ...
        if (GV.REX.W_ == 1) {
            ...
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"movd ");
            #endif
            MOD_RM(&(*pMyDisasm).Argument1, pMyDisasm);
            GV.SSE_ = 1;
            Reg_Opcode(&(*pMyDisasm).Argument2, pMyDisasm);
...
void __bea_callspec__ movq_PQ(PDISASM pMyDisasm)
{
    ...
    if (GV.PrefRepe == 1) {
        ...
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"movdqu ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
    ...
    /* ========== 0x66 */
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"movdqa ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ movq_WV(PDISASM pMyDisasm)
{
    ...
    if (GV.PrefRepne == 1) {
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"movdq2q ");
        #endif
        GV.MMX_ = 1;
        Reg_Opcode(&(*pMyDisasm).Argument1, pMyDisasm);
        GV.MMX_ = 0;
    ...
    /* ========= 0xf3 */
        ...
        GV.MemDecoration = Arg2qword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"movq2dq ");
        #endif
        GV.SSE_ = 1;
        Reg_Opcode(&(*pMyDisasm).Argument1, pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ pabsb_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"pabsb ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ pabsd_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"pabsd ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ pabsw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"pabsw ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ packsswb_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"packsswb ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ packssdw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"packssdw ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ packuswb_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"packuswb ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ paddb_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"paddb ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ paddw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"paddw ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ paddd_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"paddd ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ paddsb_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"paddsb ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ paddsw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"paddsw ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ paddusb_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"paddusb ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ paddusw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"paddusw ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ pand_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"pand ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ pandn_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"pandn ");
        #endif
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
        GV.SSE_ = 0;
...
void __bea_callspec__ pcmpeqb_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"pcmpeqb ");
        #endif
...
void __bea_callspec__ pcmpeqw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"pcmpeqw ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ pcmpeqd_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"pcmpeqd ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ pcmpgtb_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"pcmpgtb ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ pcmpgtw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"pcmpgtw ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ pcmpgtd_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"pcmpgtd ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ pmulhw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"pmulhw ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ pmullw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"pmullw ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ pmaddwd_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"pmaddwd ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ por_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"por ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ psllw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"psllw ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ psllq_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"psllq ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ psrlw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"psrlw ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ psrlq_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"psrlq ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ psraw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"psraw ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ psubb_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"psubb ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ psubw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"psubw ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ psubd_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"psubd ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ psubsb_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"psubsb ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ psubsw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"psubsw ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ psubusb_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"psubusb ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ psubusw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"psubusw ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ punpckhbw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"punpckhbw ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ punpckhwd_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"punpckhwd ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ punpckhdq_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"punpckhdq ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ punpcklbw_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"punpcklbw ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ punpcklwd_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"punpcklwd ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ punpckldq_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"punpckldq ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
...
void __bea_callspec__ pxor_(PDISASM pMyDisasm)
{
    ...
    if ((*pMyDisasm).Prefix.OperandSize == InUsePrefix) {            
        ...
        GV.MemDecoration = Arg2dqword;
        #ifndef BEA_LIGHT_DISASSEMBLY
           (void) strcpy_s ((*pMyDisasm).Instruction.Mnemonic, 16,"pxor ");
        #endif
        (*pMyDisasm).Argument1.AccessMode = READ;
        GV.SSE_ = 1;
        GxEx(pMyDisasm);
